// import { Box, Typography, Stack, FormControl, 
...
const Form = ({ type, register, handleSubmit, handleImageChange, 
  formLoading, onFinishHandler, propertyImage }: 
  FormProps) => {
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        >
          <FormControl>
            ...
            }}>Saisissez le nom de la propriété</FormHelperText>
            <TextField
              fullWidth
              required
              id="outlined-basic"
          ...
          <FormControl>
            <FormHelperText sx={{
             ...
             Saisissez la description de la propriéte
            </FormHelperText>
            <TextareaAutosize
              minRows={5}
              required
          ...
          <Stack direction="row" gap={4}>
            <FormControl sx={{flex: 1 }}>
              <FormHelperText sx={{
                ...
                Selectionnez le type de propriété
              </FormHelperText>
              ...
              >
                ...
                <MenuItem value="maison de ferme">Maison de ferme</MenuItem>
            ...
            <FormHelperText sx={{
              ...
              Saisissez le prix de la propriété            
            </FormHelperText>
            <TextField
              fullWidth
              required
          ...
          <FormControl>
            <FormHelperText sx={{
              ...
              Saisissez l'emplacement de la propriété
            </FormHelperText>
            <TextField
              fullWidth
              required
          ...
          <Stack direction="column" gap={1} justifyContent="center" marginBottom={2}>
          ...
          <CustomButton 
          type="submit"
          title={formLoading ? 'Validation...' : 'Valider'}
